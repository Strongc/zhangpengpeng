...
read	proc
	...
	int 21h
	mov cx,0h
read0:	mov bx,0h		;开始新读一个数
read1:	mov ah,1h		;新的一位
	mov al,0h
	int 21h
	cmp al,','
	je getone
